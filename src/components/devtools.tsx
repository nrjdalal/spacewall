...
const Links = [
  ...
  {
    title: "Github",
    url: "https://github.com/nrjdalal/spacewall/tree/main/src",
  },
  {
    title: "Vercel",
    url: "https://vercel.com/nrjdalals-projects/spacewall/deployments",
  },
]
    ...
    <div className="bg-background text-primary fixed right-5 bottom-5 z-100 flex items-center gap-1.5 rounded-full border font-mono text-xs font-medium select-none">
      {expandDevtools && (
        <>
          ...
          <div className="fixed right-5 bottom-16 flex items-center gap-x-3">
            {Links.map(({ title, url }) => (
              <a
                key={title}
